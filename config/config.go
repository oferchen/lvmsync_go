...
type Config struct {
	...
	Speed          int    `mapstructure:"speed_limit"`
...
func LoadConfig() (*Config, error) {
	...
	pflag.Bool("zerocopy", defaultCfg.ZeroCopy, fmt.Sprintf("Enable zero-copy transfers (only in sequential mode) (default: %v)", defaultCfg.ZeroCopy))
	...
	pflag.String("speed", humanize.Bytes(uint64(defaultCfg.Speed)), fmt.Sprintf("Speed limit (e.g. \"100MB\") (default: %s)", humanize.Bytes(uint64(defaultCfg.Speed))))
