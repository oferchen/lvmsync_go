...
// LoadChecksumState reads checksum metadata from filename or returns defaults when the file is absent.
...
// SaveChecksumState writes state to filename with restrictive permissions, overwriting any existing file.
